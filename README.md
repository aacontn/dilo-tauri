...
>
> _This build is frozen at 0.3.2. Dilo is being rewritten as a native Mac app at [aacontn/dilo](https://github.com/aacontn/dilo); see the spec linked above. Windows/Linux/Intel users: this version keeps working, or use upstream [Handy](https://github.com/cjpais/handy)._
